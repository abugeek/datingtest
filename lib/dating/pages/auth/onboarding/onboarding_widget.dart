            ...
            ClipRRect(
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/cute-young-couple-love-hugging-with-heart-shape-balloons-3d-rendering_1.png',
                    width: 200.0,
                    height: 200.0,
                    fit: BoxFit.none,
                  ),
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'uw63ma8f' /* Find your partner with us */,
                                              ),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'wg6ursos' /* Dating better than ever before */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'ax8wbgg8' /* Find your perfect match */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)

...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: SelectGenderWidget.routeName,
          path: SelectGenderWidget.routePath,
          builder: (context, params) => SelectGenderWidget(),
        ),
        FFRoute(
          name: SelectInterestsWidget.routeName,
          path: SelectInterestsWidget.routePath,
          builder: (context, params) => SelectInterestsWidget(),
        ),
        FFRoute(
